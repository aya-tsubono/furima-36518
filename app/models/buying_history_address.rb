class BuyingHistoryAddress
  ...
  attr_accessor :postcode, :area_id, :municipality, :addresses, :building, :phone_number, :buying_history_id, :user_id, :item_id,
                :token
  ...
  def save
    ...
    Address.create(postcode: postcode, area_id: area_id, municipality: municipality, addresses: addresses, building: building,
                   phone_number: phone_number, buying_history_id: buying_history.id)
  end
end
